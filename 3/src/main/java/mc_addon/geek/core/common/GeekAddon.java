package mc_addon.geek.core.common;
...
import mc_addon.geek.core.common.init.AddonBlocks;
import mc_addon.geek.core.common.init.AddonBuildingModules;
...
@Mod(GeekAddon.MOD_ID)
public class GeekAddon
{
	public static final String MOD_ID = "mc_addon_z_geek";
	...
	public void register(RegisterEvent event)
	{
		...
		{
			ModBuildings.cook.get().getModuleProducers().add(AddonBuildingModules.GEEK_MODULE_1);
			ModBuildings.cook.get().getModuleProducers().add(AddonBuildingModules.GEEK_MODULE_2);
			ModBuildings.cook.get().getModuleProducers().add(AddonBuildingModules.GEEK_MODULE_3);
		}
	...
	private void onBuildCreativeModeTabContents(BuildCreativeModeTabContentsEvent e)
	{
		...
		{
			e.accept(AddonBlocks.BLOCK_HUT_GEEK_BUILDING);
		}
